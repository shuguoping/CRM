...
public class MD5Util {
    ...
    public static final String salt = "!wJ%E";
     ...
     * @return
     */
    public static String getMD5StringWithTime(Object str) {
        return getMD5String((str + "" + System.currentTimeMillis()).getBytes());
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(MD5Util.getMD5StringWithTime("123"));
    }
}
